...
function M.new(args)
	...
	gmail.widget.image = image("/usr/share/awesome/icons/blind-alien/icons/mail.png")
	...
	function(widget, args)
		if args["{count}"] > 0 then
			widget.image = image("/usr/share/awesome/icons/blind-alien/icons/mail_new.png")
		else
			widget.image = image("/usr/share/awesome/icons/blind-alien/icons/mail.png")
		end
